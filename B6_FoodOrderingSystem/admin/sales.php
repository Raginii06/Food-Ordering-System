...
<html lang="en">
            ...
            <div class="card-body">
              <table class="table table-bordered" width="100%" cellspacing="0">
                <tbody>
                  <tr>
                    <td>Today</td>
                    <td><?php echo getSalesGrandTotal("DAY"); ?> INR</td>
                  </tr>
                  <tr>
                    <td>This Week</td>
                    <td><?php echo getSalesGrandTotal("WEEK"); ?> INR</td>
                  </tr>
                  <tr>
                    <td>This Month</td>
                    <td><?php echo getSalesGrandTotal("MONTH"); ?> INR</td>
                  </tr>
                  <tr class="table-info">
                    <td><b>All Time</b></td>
                    <td><b><?php echo getSalesGrandTotal("ALLTIME"); ?> INR</b></td>
                  </tr>
                </tbody>
              </table>
            </div>
 ...
 <span>Copyright © Paakhi, Anurag, Ragini, and Usman</span>            </div>
          </div>
        </footer>
