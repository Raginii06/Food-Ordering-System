  ...
  <body id="page-top">
    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <hr>
          <p>Manage menu by adding, modifying, or deleting items:</p>

          <div class="card mb-3 border-primary">
            <div class="card-header">
              <i class="fas fa-chart-area"></i>
              Menu List
              <button class="btn btn-primary btn-sm float-right" data-toggle="modal" data-target="#addMenuModal">Add Eatery</button>
        ...
        <footer class="sticky-footer">
          <div class="container my-auto">
            <div class="copyright text-center my-auto">
              <span>Copyright © Paakhi, Anurag, Ragini, and Usman</span>
            </div>
          </div>
        </footer>
	...
	<div class="modal fade" id="addMenuModal" tabindex="-1" role="dialog" aria-labelledby="addMenuModalLabel" aria-hidden="true">
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      <div class="modal-header">
	        <h5 class="modal-title" id="addMenuModalLabel">Add Eatery</h5>
	      ...
	      <div class="modal-body">
	        <form id="addmenuform" method="POST">
	        	<div class="form-group">
		            ...
		            <input type="text" required="required" class="form-control" name="menuname" placeholder="Include eatery's name." >
		        </div>
	        </form>
	      </div>
	      <div class="modal-footer">
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        <form id="additemform" method="POST">
		        ...
		        <div class="form-group">
		            <label class="col-form-label">Price (INR):</label>
